...
from exp2_mnz import train_exp2_two_heads_nmnz_combined_sup, train_exp2_two_heads_nmnz_combined_sup_different_batches
...
if __name__ == '__main__':
    ...
    elif exp_type == "two_heads_nmnz_comb_sup_diff_batch":
        train_exp2_two_heads_nmnz_combined_sup_different_batches(se_train, se_val, se_test, features_train, features_test, nn_model, cfg_train, cfg_dataset)
